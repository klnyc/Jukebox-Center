        ...
        return (
            <div className="album">
                ...
                <div className="album-info">
                    ...
                    <div className="album-details">{album.genre}  <ImDiamonds className="album-detail-diamond" />  {album.year}  <ImDiamonds className="album-detail-diamond" /> {album.price && this.formatPrice(album.price)}</div>
                    {album.inventory ?
                    <Fragment>
